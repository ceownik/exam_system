...
<a href="#" class="save-icon" alt="Zapisz" ><img src="/images/Save.png"  alt="Zapisz" /></a>
<a href="#" class="end-icon" alt="Zakończ test" ><img src="/images/close.png" alt="Zakończ test"  /></a>
<form id="test-form">
<?php
$counter = 0;
