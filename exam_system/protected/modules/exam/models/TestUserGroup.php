...
/**
 * This is the model class for table "test_user_group".
 *
 * The followings are the available columns in table 'test_user_group':
...
class TestUserGroup extends CActiveRecord
{
	 ...
	 * @return TestUserGroup the static model class
	 */
