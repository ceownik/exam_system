...
class QuestionSet extends CActiveRecord
{
	...
	{
		return array(
			array('create_date, create_user, last_update_date, last_update_user', 'required'),
			array('create_date, create_user, last_update_user, is_deleted', 'numerical', 'integerOnly'=>true),
	...
	{
		return array(
			'questionGroups' => array(self::HAS_MANY, 'QuestionGroup', 'set_id'),
			'questionGroupHistories' => array(self::HAS_MANY, 'QuestionGroupHistory', 'set_id'),
			'createUser' => array(self::BELONGS_TO, 'User', 'create_user'),
			'questionSetHistories' => array(self::HAS_MANY, 'QuestionSetHistory', 'id'),
		);
	}
